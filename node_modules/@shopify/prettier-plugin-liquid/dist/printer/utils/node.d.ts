...
import { HtmlSelfClosingElement, LiquidHtmlNode, TextNode, LiquidNode, HtmlNode, HtmlVoidElement, HtmlComment, HtmlElement, LiquidTag, AttributeNode, HtmlDanglingMarkerOpen, HtmlDanglingMarkerClose } from '../../types';
...
export declare function hasNoCloseMarker(node: LiquidHtmlNode): node is HtmlComment | HtmlVoidElement | HtmlSelfClosingElement | HtmlDanglingMarkerOpen | HtmlDanglingMarkerClose;
export declare function isHtmlDanglingMarkerOpen(node: LiquidHtmlNode): node is HtmlDanglingMarkerOpen;
